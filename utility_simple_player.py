...
class UtilitySimplePlayer:
    """Class that calculate the utility of every move for the simple player"""
    rules = Rules()
    ...
    def utility(self, board, move, color):
        ...
        possible_moves_for_opponent = self.rules.get_all_possible_moves(new_board, self.rules.opposite_color(color))
